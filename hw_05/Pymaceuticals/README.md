...
## Option 2: Pymaceuticals Inc ## MUST REREAD EVERYTHING CAREFULLY
...
If i'm talking about the SE of tumor volumes changing, I need to look at how my tumors were recorded and where they came from. I have lists of mice who have all taken the same meds and other mice who have taken different meds. I need to know the SE of mice per med per timepoint.

- x_axis is timepoint; y_axis is tumor volume; standard error btwn avg of values of mice per drug group;
* Creating a scatter plot that shows how the number of [metastatic](https://en.wikipedia.org/wiki/Metastasis) (cancer spreading) sites changes over time for each treatment.
- x_axis is time; y_axis is number of metastatic sites
* Creating a scatter plot that shows the number of mice still alive through the course of treatment (Survival Rate)
- x_axis is time; y_axis is mice that survived
* Creating a bar graph that compares the total % tumor volume change for each drug across the full 45 days.
- x_axis is each drug; y_axis is % of tumor vol change
...
* Your scatter plots must include [error bars](https://en.wikipedia.org/wiki/Error_bar). This will allow the company to account for variability between mice. (SE btwn means of tumor vol in mice per drug group) You may want to look into [`pandas.DataFrame.sem`](http://pandas.pydata.org/pandas-docs/stable/generated/pandas.DataFrame.sem.html) for ideas on how to calculate this.
* Remember when making your plots to consider aesthetics!
